...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[R]{\raisebox{1mm}{\includegraphics[height=8mm]{logo.png}}}
\fancyfoot[C]{\thepage}
...
\begin{titlepage}
    \thispagestyle{empty}
    \noindent\makebox[\textwidth][r]{\raisebox{18mm}[0pt][0pt]{\includegraphics[height=8mm]{logo.png}}}
    \centering
    \vspace*{1.0cm}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{4.1Pipe Installation.png}
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{4.2Exhaust Pipe Installation.png}
        \caption{Exhaust Pipe Installation}
        \label{fig:exhaust_install} % 给第二张图打标签
    \end{minipage}
\end{figure}
...
\begin{enumerate}[label=\textsf{Step \arabic*:}, leftmargin=4em]
    \item \textbf{Start}
    \item Disconnect PCS AC side AC 690V circuit breaker. $\rightarrow$
    \item Disconnect PCS DC side switch. $\rightarrow$
    \item Disconnect PCS auxiliary power supply AC 220V circuit breaker.
    \item \textbf{End}
\end{enumerate}
...
\begin{enumerate}[label=\textsf{Step \arabic*:}, leftmargin=4em]
    \item \textbf{Start}
    \item Disconnect PCS DC auxiliary power supply side switch. $\rightarrow$
    \item Disconnect the Water-cooled unit circuit breaker.
    \item \textbf{End}
\end{enumerate}
...
\begin{enumerate}[label=\textsf{Step \arabic*:}, leftmargin=4em]
    \item \textbf{Start}
    \item Press the Fire Suppression Master Unit button. $\rightarrow$
    \item Press the Wire Control Master Unit button. $\rightarrow$
    \item Disconnect the Fire Suppression main circuit breaker.
    \item \textbf{End}
\end{enumerate}
...
\begin{enumerate}[label=\textsf{Step \arabic*:}, leftmargin=4em]
    \item \textbf{Start}
    \item Close the PCS auxiliary power supply AC 220V circuit breaker. $\rightarrow$
    \item Close the PCS DC side switch. $\rightarrow$
    \item Close the PCS AC side AC 690V circuit breaker.
    \item \textbf{End}
\end{enumerate}
...
\begin{enumerate}[label=\textsf{Step \arabic*:}, leftmargin=4em]
    \item \textbf{Start}
    \item Close the Water-cooled unit circuit breaker. $\rightarrow$
    \item Close the PCS DC auxiliary power supply side switch.
    \item \textbf{End}
\end{enumerate}
...
\begin{enumerate}[label=\textsf{Step \arabic*:}, leftmargin=4em]
    ...
    \item Press the Fire Suppression Master Unit button. $\rightarrow$
    \item Press the Wire Control Master Unit button. $\rightarrow$
    \item Close the Fire Suppression main circuit breaker.
    \item \textbf{End}
\end{enumerate}
...
\begin{figure}[H]
    ...
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{6.2Front Layout of PCS.png}
        \caption{Front Layout of PCS}
    \end{minipage}
    \hfill % 在两个图片之间填充弹性间距
    % 右侧图片
    \begin{minipage}[b]{0.48\textwidth}
        \centering
        \includegraphics[width=\textwidth]{6.3Backside Layout of the PCS.png}
        \caption{Backside Layout of the PCS}
        \label{fig:back_layout} % 给第二张图打标签
    \end{minipage}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{6.4Front view of the PACK battery pack.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{6.5PACK Front Panel Installation and Removal.png}
    \caption{PACK Front Panel Installation and Removal}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{6.6Removal of the BMUP Housing.png}
    \caption{Removal of the BMUP Housing}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{6.7BMUP Board Replacement.png}
    \caption{BMUP Board Replacement}
\end{figure}
